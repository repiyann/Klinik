...
if (isset($_POST['submit'])) {
    ...
    if ($resultCheck > 0) {
        ...
        $insert = "INSERT INTO antrian VALUES('', '$user_id', '$namaPasien', '$tanggalPasien', '$kelamin', '$alamatPasien', '$tanggal', '$jam', '$layanan', '$dokter')";
        ...
        <div class="card py-3 px-3 w-50">
            ...
            <form method="post" id="cekDok">
                ...
                <div class="form-floating my-4">
                    <select class="form-select" name="kelamin" id="floatingSelect">
                        <option selected="" disabled selected> Pilihan Jenis Kelamin </option>
