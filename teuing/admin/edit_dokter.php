...
if (isset($_POST['submit'])) {
    ...
    $sql1 = "SELECT * FROM dokter WHERE namaDokter = '$dokter' AND layanan = '$layanan'";
    ...
    if ($resultCheck1 > 0) {
        ...
        $insert = "INSERT INTO dokter VALUES('', '$dokter', '$layanan')";
...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center container">
        <div class="card py-3 px-3 w-50">
            <h5 class="fw-bold text-center my-3"> Edit Dokter </h5>
            <?php
            if (isset($message)) {
            ...
            ?>
            <form method="post">
                <label class="fw-bold mb-1"> Data Dokter </label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead class="thead-dark">
                            <tr>
                                <th style="width:70%"> Dokter </th>
                                <th> Layanan</th>
                                <th> Hapus </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            $layanan = mysqli_query($conn, "select * from dokter");
                ...
                <div class="text-center container d-flex justify-content-between">
                    <a type="submit" class="btn mt-2 center" id="login" href="dokter_admin.php"> Kembali </a>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" required name="dokter" maxlength="50">
