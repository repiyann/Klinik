...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center container">
        <div class="card py-3 px-3 w-50">
            <h5 class="fw-bold text-center my-3"> Total Dokter </h5>
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        $totalHalaman = ceil($totalDokter / $limit);

                        $dataDokter = mysqli_query($conn, "SELECT * 
                        FROM DOKTER
                        LEFT JOIN layanan ON dokter.layanan = layanan.layanan_id
                        limit $pages, $limit");

                        while ($data = mysqli_fetch_array($dataDokter)) {
                        ?>
                            <tr>
                ...
                <div class="text-center container d-flex justify-content-between">
                    ...
                    <a type="submit" class="btn mt-2 center" id="login" href="edit_dokter.php"> Edit </a>
                </div>
            </div>
        </div>
