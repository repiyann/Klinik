...
if (isset($_POST['submit'])) {
    ...
    $sql1 = "SELECT * FROM users WHERE userpass = '$password'";
    ...
    if ($resultCheck1 > 0) {
        ...
        $insert = "UPDATE users SET username = '$username', email = '$email', userpass = '$confirm_password' WHERE user_id = '$user_id'";
...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center container">
        <div class="card py-3 px-3 w-50">
            <h5 class="fw-bold text-center my-3"> Profile Saya </h5>
            <?php
            if (isset($message)) {
            ...
            <form method="post" id="cekDok">
                <label class="fw-bold mb-1"> Data Akun </label>
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInput" required name="username" maxlength="50" value="<?= $profile; ?>">
                    <label for="floatingInput"> Username </label>
                </div>
                <div class="form-floating mb-3">
                    <input type="email" class="form-control" id="floatingInput" required placeholder="name@example.com" value="<?= $row['email']; ?>" name="email" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
